...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Threeitcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"threeitcointools.com", "31.220.111.201"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"threeitcointools.com", "testnet-seed.threeitcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Threeitcoin is probably already running."), addrBind.ToString().c_str());
        else
